"""
SPY Pattern Analysis Dashboard - Refactored Main Streamlit Application (Septermber Data)
"""
...
# Page configuration
st.set_page_config(page_title="SPY Pattern Mapper — Per-Pattern Projections (September Data)", layout="wide")

# Load data
@st.cache_data
def load_stock_data():
    """Load stock data with caching"""
    data_path = Path(__file__).resolve().parent / DATA_DIR / CSV_FILENAME_SEPTEMBER
